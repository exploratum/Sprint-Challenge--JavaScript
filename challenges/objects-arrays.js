...
console.log(`The ${tyrannosaurus.name} weighted ${tyrannosaurus.weight}`);
...
tyrannosaurus.roars = function() {
  return("RAWERSRARARWERSARARARRRR!")
}
console.log(`The ${tyrannosaurus.name} is roaring: ${tyrannosaurus.roars()}`);
...
console.log("************ University List sorted alphabetically **************** ")
const universities = [];
...
console.log("************ Contact Information List **************** ")
const contactInfo = [];
for (let i=0; i<graduates.length; i++) {
...
console.log("************ Universities with 'uni' string **************** ")
const uni = [];
...
console.log("************ Animal Names in lowerCase **************** ")
...
console.log("************ Animal with population < 5 **************** ")
...
console.log("******* Stretch completed - All functions are converted to arrow functions! ******");
